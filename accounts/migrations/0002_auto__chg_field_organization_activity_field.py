...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organization.activity_field'
        db.alter_column(u'accounts_organization', 'activity_field', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Organization.activity_field'
        db.alter_column(u'accounts_organization', 'activity_field', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'accounts.organization': {
            ...
            'activity_field': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
